...
def prepare_data(file_name, sequence_length):
    ...
    # Read data using paths relative to the project root (two levels up from this file)
    base_dir = pathlib.Path(__file__).resolve().parents[1]
    train_path = base_dir / 'data' / f'train_FD00{file_name}.txt'
    test_path = base_dir / 'data' / f'test_FD00{file_name}.txt'
    rul_path = base_dir / 'data' / f'RUL_FD00{file_name}.txt'
